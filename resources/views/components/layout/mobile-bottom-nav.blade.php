...
<div class="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur-2xl border-t border-slate-200/90 z-50 flex items-center justify-around py-2 px-1 shadow-[0_-5px_20px_rgba(0,0,0,0.06)] md:hidden">
    <!-- Home (Beranda) -->
