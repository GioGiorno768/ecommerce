...
>
    ...
    >
        <div>
            ...
            <div class="p-5 bg-gradient-to-r from-red-800 to-red-950 text-white flex flex-col gap-4">
                ...
                <div class="flex items-center justify-between">
                    <a href="#" class="text-xl font-black tracking-tight text-white flex items-center" style="font-family: 'Plus Jakarta Sans', sans-serif;">
                ...
                <div class="flex items-center space-x-3 pt-1">
                    ...
                    <div class="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center bg-white/10 text-white text-xs font-bold shadow-sm" style="font-family: 'Plus Jakarta Sans', sans-serif;">
                        US
                    </div>
                    <div>
                        <p class="text-[9px] text-red-200 font-bold uppercase tracking-wider leading-none" style="font-family: 'Plus Jakarta Sans', sans-serif;">Halo, Selamat Datang</p>
                        <p class="text-xs font-normal text-white mt-1" style="font-family: 'Plus Jakarta Sans', sans-serif;">Akun Saya / Masuk</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-3.5 bg-yellow-50/50 m-4 rounded-xl border border-yellow-250/70 flex items-center justify-between shadow-3xs">
                <div class="flex items-center space-x-3 text-yellow-805">
                    ...
                    <div>
                        <p class="text-xs font-semibold text-yellow-900 leading-tight" style="font-family: 'Plus Jakarta Sans', sans-serif;">Program Trade-In</p>
                        <p class="text-[10px] font-normal text-yellow-750/90 mt-0.5" style="font-family: 'Plus Jakarta Sans', sans-serif;">Tukar Tambah HP Lama</p>
                    </div>
                </div>
            ...
            <div class="px-4 py-3">
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-3 mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Kategori Utama</p>
                <nav class="space-y-1">
                    <a href="#" class="flex items-center space-x-3.5 px-3 py-2.5 rounded-xl text-slate-600 hover:text-red-900 hover:bg-red-50/40 transition-colors group">
                        ...
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Smartphone & Tablet</span>
                    </a>
                    <a href="#" class="flex items-center space-x-3.5 px-3 py-2.5 rounded-xl text-slate-600 hover:text-red-900 hover:bg-red-50/40 transition-colors group">
                        <i class="ph-light ph-laptop text-slate-400 group-hover:text-red-700 text-xl transition-colors"></i>
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Laptop & PC</span>
                    </a>
                    <a href="#" class="flex items-center space-x-3.5 px-3 py-2.5 rounded-xl text-slate-600 hover:text-red-900 hover:bg-red-50/40 transition-colors group">
                        <i class="ph-light ph-headphones text-slate-400 group-hover:text-red-700 text-xl transition-colors"></i>
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Audio Premium</span>
                    </a>
                    <a href="#" class="flex items-center space-x-3.5 px-3 py-2.5 rounded-xl text-slate-600 hover:text-red-900 hover:bg-red-50/40 transition-colors group">
                        <i class="ph-light ph-watch text-slate-400 group-hover:text-red-700 text-xl transition-colors"></i>
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Smartwatch & Fitness</span>
                    </a>
                    <a href="#" class="flex items-center space-x-3.5 px-3 py-2.5 rounded-xl text-slate-600 hover:text-red-900 hover:bg-red-50/40 transition-colors group">
                        <i class="ph-light ph-plugs text-slate-400 group-hover:text-red-700 text-xl transition-colors"></i>
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Aksesoris Original</span>
                    </a>
                </nav>
            </div>
            ...
            <div class="px-4 py-3 border-t border-slate-100 mt-2">
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-3 mb-2" style="font-family: 'Plus Jakarta Sans', sans-serif;">Layanan & Bantuan</p>
                <nav class="space-y-1 text-sm text-slate-500">
                    <a href="#" class="flex items-center justify-between px-3 py-2 hover:text-red-900 hover:bg-slate-50 rounded-lg transition-colors group">
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Cabang Terdekat</span>
                        <i class="ph-light ph-storefront text-slate-400 group-hover:text-red-750 transition-colors"></i>
                    </a>
                    <a href="#" class="flex items-center justify-between px-3 py-2 hover:text-red-900 hover:bg-slate-50 rounded-lg transition-colors group">
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Lacak Pesanan</span>
                        <i class="ph-light ph-truck text-slate-400 group-hover:text-red-750 transition-colors"></i>
                    </a>
                    <a href="#" class="flex items-center justify-between px-3 py-2 hover:text-red-900 hover:bg-slate-50 rounded-lg transition-colors group">
                        <span class="text-sm font-normal transition-colors" style="font-family: 'Plus Jakarta Sans', sans-serif;">Pusat Bantuan</span>
        ...
        <!-- Drawer Footer -->
        <div class="p-4 bg-slate-50 border-t border-slate-100 text-center text-xs text-slate-400 font-normal" style="font-family: 'Plus Jakarta Sans', sans-serif;">
